          ...
          {/* <FontAwesomeIcon icon={faXmark} color="#00A876"  size="1x"/> */}
            ...
            <div className="form">
                <form>
                    ...
                    <input className="margin input" type="email" name="email"  placeholder="test@test.ru"/>
                    <p className="input-text margin">ПАРОЛЬ:</p>
                    <input className="margin input" type="password" name="password"  placeholder="12345678"/>
                    </label>
